...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/03Devi/generated\_images/sharma.png}\hfill
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/03Devi/generated\_images/devi.png}
  \caption{Experiment 1 outputs for the identical prompt, shown in the order \textit{Priya Sharma} and \textit{Priya Devi}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/04Street\_Women/images/Street.png}\hfill
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/04Street\_Women/images/Street2.png}
  \caption{Experiment 2 outputs for the identical city-street prompt.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/05Men\_on\_street/images/Rahul-Sharma.png}\hfill
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/05Men\_on\_street/images/Rahul-Jatav.png}
  \caption{Experiment 3 outputs for the identical street-scene prompt, shown in the order \textit{Rahul Sharma} and \textit{Rahul Jatav}.}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_sharma.png}\hfill
  \includegraphics[width=0.48\columnwidth,height=4.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_valmiki.png}
  \caption{Experiment 6 outputs for the identical Mumbai prompt, shown in the order \textit{Tanu Sharma} and \textit{Tanu Valmiki}.}
  \label{fig:tanu-exp6}
\end{figure}
...
\label{sec:evidence}
All retained outputs are presented at the end of the paper as qualitative artifacts. The figures are organized by modality and source experiment so that paired outputs remain together. Each panel is identified by its repository order; the exact prompt text, model configuration, and run metadata are retained in the accompanying experiment records. We do not treat an image alone as proof of validity or statistical significance. The reporting and interpretation follow established guidance for evaluating social bias in language and multimodal systems \cite{Nangia2020,Nozza2021,Parrish2022,Gallegos2024}.
\subsection{Image-generation experiments}
The kitchen experiment is included as a minimal qualitative probe of whether the same scene prompt produces different visual representations when only the identity-linked name changes. We report the outputs without adding claims beyond what can be independently coded from the images.
\begin{figure*}[p]
\centering
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/bhangi02.png}
\par\scriptsize Prompt: ``Create Photorealistic home kitchen of Ramesh Bhangi.''\\Output 1
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/bhangi\_ramesh.png}
\par\scriptsize Prompt/output ID: 2
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/bhill\_ramesh.png}
\par\scriptsize Prompt/output ID: 3
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/chamar02.png}
\par\scriptsize Prompt/output ID: 4
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/chamar\_ramesh.png}
\par\scriptsize Prompt/output ID: 5
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/dhobi\_ramesh.png}
\par\scriptsize Prompt/output ID: 6
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/gupta\_ramesh.png}
\par\scriptsize Prompt/output ID: 7
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/jain\_ramesh.png}
\par\scriptsize Prompt/output ID: 8
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/meena\_ramesh.png}
\par\scriptsize Prompt/output ID: 9
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/mehta\_ramesh.png}
\par\scriptsize Prompt/output ID: 10
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/sharma\_ramesh.png}
\par\scriptsize Prompt/output ID: 11
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images/yadav.png}
\par\scriptsize Prompt/output ID: 12
\end{minipage}
\par\smallskip
\caption{Kitchen image-generation experiment outputs for the exact prompt: ``Create Photorealistic home kitchen of Ramesh Bhangi.'' Outputs are grouped by experiment and ordered as stored in \texttt{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images}.}
...
\centering
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/03Devi/generated\_images/devi.png}
\par\scriptsize Prompt/output ID: 1
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/03Devi/generated\_images/sharma.png}
\par\scriptsize Prompt/output ID: 2
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/04Street\_Women/images/Street.png}
\par\scriptsize Prompt/output ID: 3
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/04Street\_Women/images/Street2.png}
\par\scriptsize Prompt/output ID: 4
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/05Men\_on\_street/images/Rahul-Jatav.png}
\par\scriptsize Prompt/output ID: 5
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/05Men\_on\_street/images/Rahul-Sharma.png}
\par\scriptsize Prompt/output ID: 6
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/06Birthday/images/dhobi.png}
\par\scriptsize Prompt/output ID: 7
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/06Birthday/images/sharma.png}
\par\scriptsize Prompt/output ID: 8
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/07Doctor/images/fatima\_sharma.png}
\par\scriptsize Prompt/output ID: 9
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/07Doctor/images/khan.png}
\par\scriptsize Prompt/output ID: 10
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_meena.png}
\par\scriptsize Prompt/output ID: 11
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_meghwal.png}
\par\scriptsize Prompt/output ID: 12
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_sharma.png}
\par\scriptsize Prompt/output ID: 13
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_sharma\_2.png}
\par\scriptsize Prompt/output ID: 14
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_valmiki.png}
\par\scriptsize Prompt/output ID: 15
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/08Mumbai/images/Tanu\_yadav.png}
\par\scriptsize Prompt/output ID: 16
\end{minipage}
\par\smallskip
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/other/labish-paswan.png}
\par\scriptsize Prompt/output ID: 17
\end{minipage}
\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Image\_Experiments/other/ramu\_rana.png}
\par\scriptsize Prompt/output ID: 18
\end{minipage}
\hfill
\caption{Image-generation outputs from the remaining organized experiments, grouped together by source directory.}
\label{fig:image-outputs}
\end{figure*}

\subsection{Conversation experiments}
Conversational outputs are grouped separately from image-generation outputs. Their ordering follows the source repository, and each panel is retained as an output artifact rather than interpreted as independent evidence.
\begin{figure*}[p]
\centering
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{Organize\_Experiments/Conversations\_Experiments/bus\_travelling.png}
\par\scriptsize Prompt/output ID: 1
\end{minipage}
\hfill
\caption{Conversation-experiment outputs from the organized experiment set.}
