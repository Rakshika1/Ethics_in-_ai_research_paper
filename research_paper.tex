...
The following figures collect the supplied experiment outputs in one location. Each image is retained as submitted; no image is treated as proof of a causal effect without independent annotation or replication. The kitchen experiment is included among the later conversational outputs and is described minimally to avoid over-interpreting visual evidence.
...
\end{minipage}
\caption{Image-generation experiments: supplied experimental outputs, shown without interpretation.}
\label{fig:image-experiments}
\end{figure*}

\subsection{Conversation, kitchen, and black-screen experiments}\label{sec:conversation-experiments}
The later experiment folders contain conversational outputs, the kitchen scenario, and diagnostic black-screen outputs. They are grouped together here so the paper preserves the complete record while keeping the main narrative readable.\par\medskip
\subsection{Conversation and kitchen outputs}
\begin{figure*}[p]
\centering
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture1.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture3.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture4.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture5.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture6.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/Picture7.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp14/Picture1.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp14/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp14/Picture3.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp14/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture1.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture3.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture5.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exp15new/Picture6.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exper12/Picture1.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exper12/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exper12/Picture3.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11/exper12/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11new/Picture1.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11new/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11new/Picture3.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper11new/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper13/Picture1.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper13/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper13/Picture3.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exper13/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture1.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture3.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture4.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture5.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/Picture6.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/exp13neww/pic1.png}
\end{minipage}
\par\medskip
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/exp13neww/pic2.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/exp13neww/pic3.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.23\textwidth}
\centering
\includegraphics[width=\linewidth]{exp15/exp13neww/pic4.png}
\end{minipage}
\caption{Conversation and kitchen outputs: supplied experimental outputs, shown without interpretation.}
\label{fig:conversation-kitchen}
\end{figure*}
