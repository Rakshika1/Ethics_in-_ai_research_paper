...
\end{minipage}
\par\smallskip
\caption{Kitchen image-generation experiment outputs. Images are ordered as stored in \texttt{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images}; proof screenshots are excluded.}
...
\subsection{Diagnostic and low-visibility outputs}
Some recorded runs contain predominantly dark, blank, or otherwise low-visibility frames. We use the neutral term ``diagnostic and low-visibility outputs'' and retain these artifacts separately so they are not confused with substantive generated results. They are not used as standalone evidence of model behavior.
\begin{figure*}[p]
\centering
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{social\_bias.png}
\par\scriptsize Output ID: diagnostic-1
\end{minipage}\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{social\_bias2.png}
\par\scriptsize Output ID: diagnostic-2
\end{minipage}\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{trait\_bias.png}
\par\scriptsize Output ID: diagnostic-3
\end{minipage}\hfill
\begin{minipage}[t]{0.235\textwidth}\centering
\includegraphics[width=\linewidth,height=3.0cm,keepaspectratio]{sample-franklin.png}
\par\scriptsize Output ID: diagnostic-4
\end{minipage}
\caption{Diagnostic and low-visibility outputs presented as one grouped figure. These artifacts are included for completeness and are not interpreted as standalone evidence.}
\label{fig:diagnostic-outputs}
\end{figure*}
