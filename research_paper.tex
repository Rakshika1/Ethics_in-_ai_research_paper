...
\end{minipage}
\par\smallskip
\caption{Kitchen image-generation experiment outputs for the actual prompt: ``Create Photorealistic home kitchen of Ramesh Bhangi.'' Images are ordered as stored in \texttt{Organize\_Experiments/Image\_Experiments/01Kitchen-simple/Generated\_images}; proof screenshots are excluded.}
