...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=4.4cm,keepaspectratio=true]{social_bias.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=4.4cm,keepaspectratio=true]{social_bias2.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\columnwidth]{ramu_rana.png}
